...
class ProjectController extends BaseController
{
    ...
    public function projectViewTasks(Request $request)
    {
        if ($this->modules && !in_array("projects", $this->modules)) {
            abort(401);
        }
        ...
        return \view("projects.project-task", [
            "selected_navigation" => "projects",
            "project" => $project,
            "todos_projects" => $todos_projects,
            "members" => $members,
    ...
    public function projectViewFiles(Request $request)
    {
        if ($this->modules && !in_array("projects", $this->modules)) {
            abort(401);
        }
        ...
        return \view("projects.project-files", [
            "selected_navigation" => "projects",
            "project" => $project,
            "todos_projects" => $todos_projects,
            "members" => $members,

...
@section('content')
    ...
    <div class="page-header card min-height-250 "@if(!empty($user->cover_photo))
         style="background-image: url(uploads/{{$user->cover_photo}}'); background-position-y: 50%;"
        @endif>
        ...
        <div class="row gx-4">
            <div class="col-auto">
                <div class="avatar rounded-circle avatar-xxl position-relative border-avatar">
                    ...
                    @else
                        <img src="uploads/{{$user->photo}}" class="w-100 border-radius-lg shadow-sm">
                    @endif
    ...
    <div class="row  mb-5">
      ...
      <!--  <div class="col-md-4">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong
                                class="text-dark">{{__('Full Name:')}}</strong> {{$user->first_name}} {{$user->last_name}}
                        </li>
                        <li class="list-group-item border-0 ps-0 text-sm"><strong
                                class="text-dark">{{__('Mobile Number:')}}</strong> {{$user->mobile_number}}</li>
                        <li class="list-group-item border-0 ps-0 text-sm"><strong
                                class="text-dark">{{__('Email:')}}</strong> {{$user->email}}</li>
                        <li class="list-group-item border-0 ps-0 text-sm"><strong
                                class="text-dark">{{__('Account Created:')}}</strong> {{$user->created_at}}</li>
                    </ul>
        ...
        <div class="col-md-10 mt-lg-0 mt-4">

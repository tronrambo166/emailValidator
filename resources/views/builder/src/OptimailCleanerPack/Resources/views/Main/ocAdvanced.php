{{ title_render::Berevi Collection - Optimail Cleaner Panel }}

{{ style_render:: }}

        <!-- Kartik fileinput -->
        <link rel="stylesheet" 
        href="{{ app_path }}/vendor/kartik-v/bootstrap-fileinput/css/fileinput.css" media="all" type="text/css">
        <!-- Simple Sidebar -->
        ...
        <link rel="stylesheet" 
        href="{{ app_path }}/vendor/bootstrap-tour/build/css/bootstrap-tour-standalone-brv.css">
        <!-- Zebra dialog -->
        <link rel="stylesheet" 
        href="https://cdn.jsdelivr.net/npm/zebra_dialog@latest/dist/css/flat/zebra_dialog.min.css">
        <!-- Custom styles -->
        <link rel="stylesheet" href="{{ app_path }}/css/oc-advanced.css">
...
{{ script_body_render:: }}
        ...
        <script src="{{ app_path }}/vendor/kartik-v/bootstrap-fileinput/js/fileinput.js"></script>
        <!-- Optionally if you need a theme like font awesome theme you can include it as mentioned below -->
        <script src="{{ app_path }}/vendor/kartik-v/bootstrap-fileinput/themes/fa/theme.min.js"></script>
        <!-- Optionally if you need translation for your language then include locale file as mentioned below -->
        <script src="{{ app_path }}/vendor/kartik-v/bootstrap-fileinput/js/locales/fr.js"></script>
        <!-- Select2 -->
        ...
        <!-- Bootstrap tour standalone -->
        <script src="{{ app_path }}/vendor/bootstrap-tour/build/js/bootstrap-tour-standalone.min.js"></script>
        <!-- Zebra dialog -->
        <script src="https://cdn.jsdelivr.net/npm/zebra_dialog/dist/zebra_dialog.min.js"></script>
        <!-- Custom script -->
        <script type="text/javascript" src="{{ app_path }}/js/oc-advanced.js"></script>
        <!-- Menu Toggle Script -->
        ...
        $(document).ready(function() {
            ...
            $input.fileinput({
                ...
                uploadUrl: '{{ app_path }}/admin/panel/optimail/runtime',
            ...
            function timerCount() {
                $.ajax({
                    url: '{{ app_path }}/admin/panel/optimail/timer',
                    type : 'POST',
                    success: function(data) {
                        if (data["percent"][0] < 100 && data["reload"][0] == 1) {
                            ...
                            $('#brv-finished').click(function(){window.location.href = "{{ app_path }}/admin/panel/optimail/tables"; return false;});
                            stopTimer();
                        }
                    },
                    dataType: "json"
        ...
        function bounceMail() {
            ...
            $.ajax({
                url: '{{ app_path }}/admin/panel/optimail/bounce/mail',
                type : 'POST',
                success: function(data) {
                    if (data) {
                        $(".brv-inbox").text(data);
        ...
        function recordsTable() {
            window.location.href = "{{ app_path }}/admin/panel/optimail/tables/bounce";
        }
        </script>
...
{{ @include::BereviCollectionPack:Main:adminPanel.php }}
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-body brv">
                                ...
                                <a href="{{ app_path }}/admin/logout" class="btn btn-outline-orange active pull-right" role="button" aria-pressed="true">
                ...
                <div class="jumbotron masthead-page">
                    ...
                    <p class="float-left brv-app-button" id="download">
                        ...
                        <button type="button" class="btn btn-light btn-sm" id="tour" onclick="location.href='{{ app_path }}/admin/panel/optimail/tables';">
                    ...
                    <hr>
                    <form id="optimail-form" method="post" enctype="application/x-www-form-urlencoded" accept-charset="UTF-8">
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <div class="form-group" id="reflex">
                        ...
                        <div class="d-flex justify-content-center">
                            <button id="launch" type="submit" class="btn btn-primary">Clean my email addresses</button>
                        </div>
                    </form>
                </div>
            </div>

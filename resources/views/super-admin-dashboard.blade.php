            ...
            <div class="card bg-light">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class=" text-dark text-sm mb-0 text-capitalize font-weight-bold">{{__('Total Workspaces')}}</p>
            ...
            <div class="card bg-gradient-dark">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm text-white mb-0 text-capitalize font-weight-bold">{{__('dashboard.Plans')}}</p><h5 class="font-weight-bolder text-white mt-4 ">
                                    {{$total_plans}}
                                </h5>
                            </div>
                        </div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            @foreach($recent_workspaces as $workspace)
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-xs font-weight-bold mb-0">{{$workspace->created_at}}</p>
